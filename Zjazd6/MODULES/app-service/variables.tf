...
ase_vnet_endpoints:     Okresla, ktore endpointy ASE sa opubliowane w VNET. Ma zastosowanie tylko w przypadku wdrozenia poprzez Internal Load Balancer. Dopuszczonlne wartosci "Web", "Publishing", "Web,Publishing", "None". 
